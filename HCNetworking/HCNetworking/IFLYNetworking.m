...
@implementation IFLYNetworking

+ (IFLYNetworking *)sharedIFLYNetworking {
    static IFLYNetworking *handler = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        handler = [[IFLYNetworking alloc] init];
    });
    return handler;
}
...
+(IFLYURLSessionTask *)uploadWithImage:(UIImage *)image
    ...
    __block IFLYURLSessionTask *sessionTask = [manager POST:urlStr parameters:params constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
        //压缩图片
    ...
    [mgr setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status) {
        ...
        switch (status) {
            case AFNetworkReachabilityStatusUnknown: // 未知网络
                //(@"未知网络");
                [IFLYNetworking sharedIFLYNetworking].networkStats=StatusUnknown;
                break;
            case AFNetworkReachabilityStatusNotReachable: // 没有网络(断网)
                // DLog(@"没有网络");
                [IFLYNetworking sharedIFLYNetworking].networkStats=StatusNotReachable;
                break;
            case AFNetworkReachabilityStatusReachableViaWWAN: // 手机自带网络
                //  DLog(@"手机自带网络");
                [IFLYNetworking sharedIFLYNetworking].networkStats=StatusReachableViaWWAN;
                break;
            case AFNetworkReachabilityStatusReachableViaWiFi: // WIFI
                [IFLYNetworking sharedIFLYNetworking].networkStats=StatusReachableViaWiFi;
